        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <?php echo app('translator')->getFromJson('laravelusers::modals.edit_user__modal_text_confirm_title'); ?>
                </h5>
            ...
            <div class="modal-body">
                <p>
                    <?php echo app('translator')->getFromJson('laravelusers::modals.confirm_modal_title_text'); ?>
                </p>
            </div>
